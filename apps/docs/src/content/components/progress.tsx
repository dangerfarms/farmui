...
<Progress value={65} animated />`,
  ...
  accessibility: [
    ...
    "Under forced colors (Windows High Contrast) the fill paints with Highlight via forced-color-adjust: none and the track gains a CanvasText border — the bar stays visible where background paint is normally stripped.",
