...
const doc: ComponentContent = {
  ...
  accessibility: [
    "Each item is a real <details>/<summary>, so toggling, Enter/Space activation, focusability and the expanded/collapsed announcement all come from the platform, so items work before and without JavaScript.",
