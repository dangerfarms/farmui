...
<Toast.Provider>
  ...
  howItWorks: [
    ...
    },
    {
      ...
      body: "The toast region is a labelled landmark, and F6 jumps focus into it from anywhere — how a keyboard user reaches an action before the timer ends. Keeping that path clear takes no effort — just don't wrap toasts in extra focusable chrome.",
    },
  ],
  accessibility: [
