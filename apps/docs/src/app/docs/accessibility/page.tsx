    ...
    <div className={prose.prose}>
      ...
      <ul>
        <li>
          ...
          (focus containment, Escape, and focus restore are the browser&apos;s),
          accordions are <code>&lt;details&gt;</code>/
        ...
        <li>
          ...
          <code>role=&quot;alert&quot;</code> and interrupts. Field errors are{" "}
          <code>role=&quot;alert&quot;</code> and joined to their control via
          composed <code>aria-describedby</code>.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          inside, arrow keys rove real focus (looping), Home/End jump, typing
          jumps to the next matching item, and Escape or activation returns
        ...
        <li>
          ...
          F6 jumps into the <strong>toast</strong> viewport (a labelled region)
      ...
      <p>
        The user&apos;s stated preferences are the default state, and everything
        beyond them is an explicit opt-in:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          carried only by background paint (switch tracks, radio dots, progress
          fills, selection highlights) it is re-expressed in system colours (
          <code>Highlight</code>, <code>CanvasText</code>, <code>GrayText</code>
          ) inside <code>@media (forced-colors: active)</code>.
        </li>
      </ul>
      ...
      <ul>
        <li>
          An axe audit runs over a representative render of every component in
          the unit suite, and keyboard behaviour (roving focus, looping,
          typeahead, focus return, dismissal) is asserted by interaction tests.
        </li>
        <li>
          Storybook runs the a11y addon and interaction tests in a real browser,
          covering what jsdom cannot (native dialog focus, popovers, computed
          styles).
        </li>
        <li>
